    ...
    public class WebAppTests
    {
        ...
        public void CheckEnvironmentVariables_ShouldPass_WhenAllVariablesExist()
        {
            Dictionary<string, string?> configValues = new()
            {
                ...
                [ApplicationVariables.MAIN_SERVER] = "main",
                [ApplicationVariables.DB_CONNECTION] = "conn",
                [ApplicationVariables.COMPARISON_FILE] = "cmp",
                [ApplicationVariables.WORDS_CLOUD_SRORAGE_ADDRESS] = "addr",
                [ApplicationVariables.WORDS_CLOUD_SRORAGE_LOGIN] = "login",
                [ApplicationVariables.WORDS_CLOUD_SRORAGE_PASSWORD] = "pwd",
                [ApplicationVariables.WORDS_CLOUD_SRORAGE_BUCKET] = "bucket",
                [ApplicationVariables.WORDS_CLOUD_SRORAGE_SSL] = "true"
            };
